...
<div class="page-content">
  ...
  <div class="page-header">
    ...
    <div class="page-header-text">
      <h2>My Savings</h2>
      <p>View your savings accounts and transaction history.</p>
    </div>
  </div>
  ...
  <div class="stat-grid">
    ...
    <div class="stat-card">
      <div class="stat-icon green"><i class='bx bx-coin-stack'></i></div>
      <div class="stat-info">
    ...
    <div class="stat-card">
      <div class="stat-icon orange"><i class='bx bx-transfer-alt'></i></div>
      <div class="stat-info">
    ...
    <div class="stat-card">
      <div class="stat-icon teal"><i class='bx bx-trending-up'></i></div>
      <div class="stat-info">
        <div class="stat-label">Interest Earned</div>
        <div class="stat-value">&#8369;0</div>
        <div class="stat-sub">Total accrued</div>
      </div>
    </div>
  </div>
  ...
  <div class="card">
    <div class="tab-bar">
      <button class="tab-btn active" onclick="switchTab(this,'tab-accounts')">My Accounts</button>
      <button class="tab-btn" onclick="switchTab(this,'tab-transactions')">Transactions</button>
    </div>
