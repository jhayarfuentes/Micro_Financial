...
<div class="page-content">
  ...
  <div class="page-header">
    <div class="page-header-icon"><i class='bx bx-line-chart'></i></div>
    <div class="page-header-text">
      <h2>Reports &amp; Performance Dashboards</h2>
      <p>Generate operational reports and track key performance indicators.</p>
    ...
    <div class="page-header-actions">
      <button class="btn btn-outline btn-sm"><i class='bx bx-export'></i> Export Report</button>
    </div>
  </div>
  ...
  <div class="stat-grid">
    <div class="stat-card">
      <div class="stat-icon blue"><i class='bx bx-file-blank'></i></div>
      <div class="stat-info">
        <div class="stat-label">Total Reports</div>
        <div class="stat-value">0</div>
        <div class="stat-sub">All generated</div>
      </div>
    </div>
    <div class="stat-card">
    ...
    <div class="stat-card">
      ...
      <div class="stat-info">
        <div class="stat-label">PAR &gt; 30 Days</div>
        <div class="stat-value">0%</div>
        <div class="stat-sub">Portfolio at risk</div>
      </div>
    </div>
    <div class="stat-card">
      <div class="stat-icon teal"><i class='bx bx-calendar-check'></i></div>
      <div class="stat-info">
        <div class="stat-label">Reports This Month</div>
        <div class="stat-value">0</div>
        <div class="stat-sub">Generated this period</div>
      </div>
    </div>
  </div>
  ...
  <div class="card">
    ...
    <!-- Tab Bar -->
    <div class="tab-bar">
      <button class="tab-btn active" onclick="switchTab(this,'tab-reports')">Report Log</button>
      <button class="tab-btn" onclick="switchTab(this,'tab-kpi')">KPI Summary</button>
      <button class="tab-btn" onclick="switchTab(this,'tab-scheduled')">Scheduled Reports</button>
    </div>
    ...
    <div id="tab-reports" class="tab-pane active">
      ...
      <div class="card-header" style="border-top:none;border-bottom:1px solid var(--border);">
        <div class="card-title"><i class='bx bx-file-blank'></i> Generated Reports</div>
        <div class="card-actions">
          <button class="btn btn-outline btn-sm"><i class='bx bx-filter-alt'></i> Filter</button>
          <button class="btn btn-primary btn-sm"><i class='bx bx-plus'></i> Generate Report</button>
        </div>
      </div>

      <!-- Report Type Legend -->
      <div class="legend-bar">
        <span class="legend-label">Report Type:</span>
        <span class="badge badge-blue">Loan</span>
        <span class="badge badge-green">Savings</span>
        <span class="badge badge-orange">Collection</span>
        <span class="badge badge-teal">Compliance</span>
    ...
    <div id="tab-kpi" class="tab-pane">
      ...
      <div class="card-header" style="border-top:none;border-bottom:1px solid var(--border);">
        <div class="card-title"><i class='bx bx-line-chart'></i> Key Performance Indicators</div>
        <div class="card-actions">
          <button class="btn btn-outline btn-sm"><i class='bx bx-export'></i> Export KPIs</button>
        </div>
      </div>
    ...
    <div id="tab-scheduled" class="tab-pane">

      <div class="card-header" style="border-top:none;border-bottom:1px solid var(--border);">
        <div class="card-title"><i class='bx bx-calendar-event'></i> Scheduled Reports</div>
        <div class="card-actions">
          <button class="btn btn-primary btn-sm"><i class='bx bx-plus'></i> Schedule Report</button>
        </div>
      </div>
