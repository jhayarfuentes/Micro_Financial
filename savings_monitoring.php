...
<div class="page-content">
  ...
  <div class="page-header">
    <div class="page-header-icon"><i class='bx bx-signal-5'></i></div>
    <div class="page-header-text">
      <h2>Savings &amp; Collection Monitoring</h2>
      <p>Monitor savings balances and collection statuses across accounts.</p>
    ...
    <div class="page-header-actions">
      <button class="btn btn-primary"><i class='bx bx-plus'></i> Add Monitor Record</button>
    </div>
  </div>
  ...
  <div class="stat-grid">
    <div class="stat-card">
      <div class="stat-icon blue"><i class='bx bx-signal-5'></i></div>
      <div class="stat-info">
        <div class="stat-label">Total Monitored</div>
        <div class="stat-value">0</div>
        <div class="stat-sub">Accounts under watch</div>
      </div>
    </div>
    <div class="stat-card">
      ...
      <div class="stat-info">
        ...
        <div class="stat-value">0</div>
        <div class="stat-sub">Meeting targets</div>
      </div>
    </div>
    <div class="stat-card">
      <div class="stat-icon orange"><i class='bx bx-trending-down'></i></div>
      <div class="stat-info">
        <div class="stat-label">Behind / Overdue</div>
        <div class="stat-value">0</div>
        <div class="stat-sub">Below expected balance</div>
      </div>
    </div>
    <div class="stat-card">
      <div class="stat-icon teal"><i class='bx bx-bell'></i></div>
      <div class="stat-info">
        <div class="stat-label">Reminders Sent</div>
        <div class="stat-value">0</div>
        <div class="stat-sub">Notifications dispatched</div>
      </div>
    </div>
  </div>
  ...
  <div class="card">
    ...
    <div class="card-header">
      <div class="card-title"><i class='bx bx-signal-5'></i> Savings Collection Monitor</div>
    ...
    <div class="status-legend">
      <span class="legend-label">Collection Status:</span>
      <span class="badge badge-green">On Track</span>
      <span class="badge badge-orange">Behind</span>
      <span class="badge badge-red">Overdue</span>
      <span class="badge badge-gray">Inactive</span>
      <span class="legend-divider"></span>
      <span class="legend-label">Variance = Actual Balance &minus; Expected Balance</span>
    </div>

    <!-- Savings Monitoring Table -->
    ...
    </div><!-- /Savings Monitoring Table -->

  </div><!-- /Monitoring Table Card -->
